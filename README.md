...
Libraries are shareable across libraries and applications. They can be imported from `@nx-jest-unit-test-fun/mylib`.
...
- `npx create-nx-workspace nx-jest-unit-test-fun`
